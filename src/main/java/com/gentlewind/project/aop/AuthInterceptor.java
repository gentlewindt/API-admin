...
public class AuthInterceptor {
    ...
    public Object doInterceptor(ProceedingJoinPoint joinPoint, AuthCheck authCheck) throws Throwable { // 是在方法声明中指定的异常声明，它表示方法可能会抛出任何类型的异常
        ...
        List<String> anyRole = Arrays.stream(authCheck.anyRole()).filter(StringUtils::isNotBlank).collect(Collectors.toList()); //String::isNotBlank相当于StringUtils.isNotBlank(),更加简洁
